...
public class Join_AppManager : MonoBehaviour
{
    ...
    void PlayerPrefabsReset()
    {
        ...
        //PlayerPrefs.SetString("Busan_Player_Face", "Asian");
        //PlayerPrefs.SetString("Busan_Player_SkinColor", "FaceApricot");
        //PlayerPrefs.SetString("Busan_Player_Hair", "Hair1");
        //PlayerPrefs.SetString("Busan_Player_HairColor", "HairBrown");
        ...
        //장착 아이템 스타일
        //PlayerPrefs.SetString("Busan_Wear_HairStyleName", "Hair1");
