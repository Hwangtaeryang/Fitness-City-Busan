        ...
        else if (nicknameStr != "")
        {
            ...
            if (curseState.Equals(true))
            {
                if (PlayerPrefs.GetString("Busan_Language").Equals("KO"))
                    ...
                    _overlapText.text = "You used slang. Please enter it again.";
            }
            //특수문자 사용
            else if (specialState == true)
            {
                ...
                if (PlayerPrefs.GetString("Busan_Language").Equals("KO"))
                    ...
                    _overlapText.text = "Do not use special characters.";
            }
            else if (curseState.Equals(false) && specialState == false && nullState == false)
            {
                ...
                else
                {
                    ...
                    if (PlayerPrefs.GetString("Busan_Language").Equals("KO"))
                        ...
                        _overlapText.text = "Nickname is successful";
                }
            }
        }
